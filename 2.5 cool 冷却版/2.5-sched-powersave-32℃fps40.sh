...
echo "1 3" > /proc/ppm/policy/userlimit_max_cpu_core
echo "2 1" > /proc/ppm/policy/userlimit_max_cpu_core
echo "0 624000" > /proc/ppm/policy/userlimit_min_cpu_freq
echo "1 741000" > /proc/ppm/policy/userlimit_min_cpu_freq
echo "2 304200" > /proc/ppm/policy/userlimit_min_cpu_freq
echo "0 949000" > /proc/ppm/policy/userlimit_max_cpu_freq
echo "1 1209000" > /proc/ppm/policy/userlimit_max_cpu_freq
...
echo "20 221000:30 338000:40 4818000:50 715000:65 897000:75 1118000:85 1391000:95 20 325000:30 559000:40 741000:50 1092000:60 1274000:65 1495000:75 1703000:85 1846000:95 20 304200:30 7410000:40 101000:50 1222000:60 1495000:65 1768000:75 1963000:85 2106000:95" > /sys/devices/system/cpu/cpufreq/interactive/target_loads
#调节CPU负载采样间隔
