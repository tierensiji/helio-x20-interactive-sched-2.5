...
echo "18000 559000:18000 715000:28000 897000:38000 1092000:38000 1222000:38000" > /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay
#调节升频频率
chmod 0666 /sys/devices/system/cpu/cpufreq/interactive/hispeed_freq
echo 1846000 > /sys/devices/system/cpu/cpufreq/interactive/hispeed_freq
#调节升频所需负载条件
...
echo 60 > /proc/hps/rush_boost_threshold
#启用休眠
...
echo "4-9" > /dev/cpuset/foreground/cpus
