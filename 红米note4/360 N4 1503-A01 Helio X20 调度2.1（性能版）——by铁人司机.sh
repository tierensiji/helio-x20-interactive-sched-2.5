...
echo "18000 1080000:58000 1180000:18000 1280000:58000 1380000:38000 1480000:58000" > /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay
#调节升频频率
...
#调节升频所需负载条件
chmod 0666 /sys/devices/system/cpu/cpufreq/interactive/go_hispeed_freq
echo 93 > /sys/devices/system/cpu/cpufreq/interactive/go_hispeed_freq
#调节最小降频间隔
...
echo 95 > /proc/hps/rush_boost_threshold
#启用休眠
...
echo "0-1,4-7,8" > /dev/cpuset/foreground/cpus
...
echo "5 0" > /proc/gpufreq/gpufreq_limited_low_batt_volt_ignore
echo "5 0" > /proc/gpufreq/gpufreq_limited_low_batt_volume_ignore
echo "5 301500" > /proc/gpufreq/gpufreq_limited_power
echo "5 0" > /proc/gpufreq/gpufreq_limited_thermal_ignore
